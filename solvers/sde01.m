%sde01  Solve Stratonovich SDE using the Stratonovich-Heun method.
...
function sol = sde01(odefun,sdefun,tspan,y0,options,varargin)
    ...
    for indx=2:tcount        
        ...
        % integration steps between calls to OutputFcn. Nonetheless, a single
        % integration step might (perversely) span multiple time points in tspan.
