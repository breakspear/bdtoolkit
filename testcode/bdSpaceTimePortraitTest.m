% Test function for bdSpaceTimePortrait
function [bdspacetimeportrait, bdcontrol] = bdSpaceTimePortraitTest(sys)
    ...
    %tabgroup1 = uitabgroup(panel1,'Units','pixels');
    ...
    % contstruct the space-time portrait panel
    bdspacetimeportrait = bdSpaceTimePortrait(tabgroup1,'Space-Time',sys,bdcontrol)
end
